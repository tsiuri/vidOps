...
from vidops.models.analysis_task import AnalysisTask, TaskStatus
from vidops.config import load_config

# Create a minimal AnalysisDatabase wrapper for vidops database connection
...
class AnalysisTaskRepository:
    ...
    def get_job_tasks(self, job_id: str) -> List[AnalysisTask]:
        ...
        return [AnalysisTask.from_row(r) for r in rows]
